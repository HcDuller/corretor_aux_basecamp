...
echo "Pressione enter para iniciar ex05" && read A && gcc -Wall -Wextra -Werror exec06.c && ./a.out ; read A && clear
echo "Pressione enter para iniciar ex05" && read A && gcc -Wall -Wextra -Werror exec07.c && ./a.out ; read A && clear
echo "Pressione enter para iniciar ex05" && read A && gcc -Wall -Wextra -Werror exec08.c && ./a.out ; read A && clear